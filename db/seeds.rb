...
<h2>왜 이것을 한국형 네오나치라고 부를 수 있는가</h2>
<p>물론 법적으로 특정인을 곧바로 "네오나치"라고 단정하는 문제는 별개일 수 있습니다. 하지만 사고방식만 놓고 보면 충분히 네오나치적이라고 부를 만합니다.</p>
...
Blog.create!(
  ...
  blog_category_id: 2,
  user_id: 1,
  title: '몽골제국이 오래 가지 못한 이유, 술과 알코올 중독',
...
Blog.create!(
  ...
  tag_list: '환빠, 유사역사학, 역사 국뽕, 역사 음모론, 고구려 중원 정복설, 백제 대륙설, 역사 왜곡',
