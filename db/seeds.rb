...
Blog.create!(id: 61, blog_category_id: 1, user_id: 1, title:'제발 호갱 그만 당하고 알뜰폰으로 바꿔요' ,tag_list: '알틀폰, 호갱,', description: '언제까지 호갱으로 살겁니까? 호갱탈출!!',
created_at:'2026-05-08 12:42:32',
updated_at:'2026-05-08 12:42:32',
content: '편의점 하는 친구를 통해 알게된 알콜중독자가 한 명 있는데
이런저런 이야기를 하다가 핸드폰 요금제 이야기가 나왔고 저는 자랑스럽게 나의 "알뜰폰" 요금제를 이야기 했습니다.
그런데 그 알콜중독자가 "알뜰폰?? 그거 노인들 쓰는거 아니야??" 이런 소리를 했었습니다.
...
그런데 문제는 제가 아무리 이것이 잘못된거고 알뜰폰으로 바꾸라고 해도 먹히지가 않는다는겁니다.
알콜중독 문제도 그렇게 뭔가 바르게 바뀌는것을 싫어하는 친구인듯 합니다.

그런데 비단 저 알콜중독자 친구 뿐 아니라 전국에 아직도 알뜰폰을 쓰지 않는 저런 호갱님들이 너무 많지요
알뜰폰 사용자 1000만을 찍어서 다행지만, 아직도 3500만의 호갱님들이 남아 있다는 소리지요

다들 저런 호갱을 벗어나 알뜰폰으로 이동하여 이유없이 나가는 요금을 없애요~
')
