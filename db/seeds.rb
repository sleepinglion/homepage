...
User.create!(id: 2, email: 'company5@jedaeroweb.co.kr', nickname: '저장강박증', password: 'a12345', password_confirmation: 'a12345', url: 'https://www.jingyu.pe.kr')
User.create!(id: 3, email: 'company6@jedaeroweb.co.kr', nickname: '예쁜간호사', password: 'a12345', password_confirmation: 'a12345', url: 'https://www.seonmi.pe.kr')
...
GuestBook.create!(id: 3, user_id: 1, title: '좋네요', count: 47, content: '<p>좋은내용 많이 보고 갑니다.<br />
 ...
 앞으로도 많이 방문할께요~</p>
 ')
GuestBook.create!(id: 4, user_id: 2, title: '잘보고 갑니다.', content: '재미있고 유익한 내용이 많네요
 자주 방문할께요~')
GuestBook.create!(id: 5, user_id: 3, title: '좋은홈페이지네요', content: '앞으로도 놀러올께요
 계속 업그레이드 해주세요')
...
Blog.create!(
  ...
  blog_category_id: 2,
  user_id: 1,
  title: '살인청부업자와 장기밀매조직은 왜 현실에서 유지되기 어려울까',
  tag_list: '게임이론, 살인청부업자, 장기밀매조직, 범죄조직, 영화속범죄, 범죄의 현실성, 죄수의 딜레마',
  description: '영화에서 자주 등장하는 살인청부업자와 장기밀매조직은 왜 현실에서 오래 유지되기 어려울까? 게임이론과 배신 구조를 통해 범죄 조직의 비현실성을 살펴본다.',
  is_html: true,
  content: %q(
    <h2>살인청부업자와 장기밀매조직은 왜 현실에서 유지되기 어려울까</h2>
...
created_at:'2026-04-20 12:42:32',
updated_at:'2026-04-20 12:42:32',
content: '')
...
Blog.create!(id: 55, blog_category_id: 4, user_id: 1, title:'영어도 보면 사람사는곳 다 똑같군',tag_list: '영어, 예의, 존대말', description: '',
content: '')


Blog.create!(id: 55, blog_category_id: 4, user_id: 1, title:'중국 독재, 통제 비판',tag_list: '', description: '',
content: '')
