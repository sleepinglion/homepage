...
Blog.create!(id: 48, blog_category_id: 2, user_id: 1, title:'국뽕,네오나치 사상 가진 친구가 있네요',tag_list: '국뽕, 나치, 네오나치', description: '국뽕을 넘어서 네오나치가 된 친구',
...
Blog.create!(id: 49, blog_category_id: 2, user_id: 1, title:'사이비중의 사이비 "창조과학"을 아시나요?',tag_list: '창조과학, 사이비, 진화론, 창조론', description: '',
...
Blog.create!(id: 54, blog_category_id: 4, user_id: 1, title:'뭐?? 빙하수가 위험해?? 무식하다 무식해',tag_list: '빙하, 수자원', description: '인류에게 끊임없이 깨끗한 물을 공급해주는 빙하',
