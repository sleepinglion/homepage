...
Blog.create!(id: 61, blog_category_id: 1, user_id: 1, title:'제발 호갱 그만 당하고 알뜰폰으로 바꿔요' ,tag_list: '알틀폰, 호갱, 알콜중독', description: '언제까지 호갱으로 살겁니까? 호갱탈출!!',
created_at:'2026-05-08 12:42:32',
updated_at:'2026-05-08 12:42:32',
content: '편의점 하는 친구를 통해 알게된 알콜중독자가 한 명 있는데
이런저런 이야기를 하다가 핸드폰 요금제 이야기가 나왔고 저는 자랑스럽게 제 "알뜰폰" 요금제를 이야기 했습니다.
그런데 그 알콜중독자가 "알뜰폰?? 그거 노인들 쓰는거 아니야??" 이런 소리를 하여서 황당했던 기억이 있습니다.

역시 그 알콜중독자를 알아가다보니 도통 세상일을 모르고, 여러 사람들에게 호갱 당하며 살고 있는 친구 였었습니다.
그러니 알뜰폰을 모르고 인식이 그 정도 였던거이지요
그 친구 요금제는 무려 매월 69000원...... ㅜ.ㅜ,  그 때 저의 알뜰폰은 1500원이였습니다.(지금은 100원 짜리로 이동했어요)
반면 수입은 제가 더 높았지요, 훨씬 수입 낮은 알콜중독자가 69000원....

그렇다고 저런 통신사 호갱요금제의 쿠폰,서비스등도 전혀 이용하지 않는 친구였습니다.
또한 데이터 사용량을 보니 저의 알뜰폰 요금제로도 넘치지 않는 사용량 이였습니다.

참..... 기가 막히지요??
통신사들은 이런 호갱들에게 돈을 얼마나 잘 뜯어내는 걸까요?, 이런거는 거의 치매 노인에게 보험가입시키는 사기급 아닌가요?
사리판별 안되는 알콜중독자에게 저런 요금제라니..

문제는 제가 아무리 이것이 잘못된거고 알뜰폰으로 바꾸라고 해도 먹히지가 않는다는겁니다.
알콜중독 문제도 그렇게 뭔가 바르게 바뀌는것을 싫어하는 친구인듯 합니다.

비단 저 알콜중독자 친구 뿐 아니라 전국에 아직도 알뜰폰을 쓰지 않는 저런 호갱님들이 너무 많지요
알뜰폰 사용자 1000만을 찍어서 다행지만, 아직도 3500만의 호갱님들이 남아 있다는 소리지요

다들 저 처럼(월 100원) 알뜰폰으로 이동하여 통신사들에게 호갱 당하지 마세요~
대한민국의 앞선 1000만명에 포함되고, 뒤쳐진 3500만명에서 벗어나세요
')
...
Blog.create!(id: 63, blog_category_id: 3, user_id: 1, title:'한자 모르는 한심한 대한민국 국민들',tag_list: '한자, 한글전용, 무지, 무식', description: '한글전용화 주장,시행한 관련자들이말로 진정한 매국노다',
content: '요즘 SNS나 인터넷 게시글들은 보면 기본 단어 맞춤법도 틀린것을 많이 보게 됩니다.')



Blog.create!(id: 64, blog_category_id: 4, user_id: 1, title:'영어도 보면 사람사는곳 다 똑같군',tag_list: '영어, 예의, 존대말', description: '',
content: '')


Blog.create!(id: 65, blog_category_id: 4, user_id: 1, title:'중국 독재, 통제 비판',tag_list: '', description: '',
content: '')
